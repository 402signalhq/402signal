...
async function readBounded(response, maxBytes, controller) {
  ...
  // Content-Length can describe compressed bytes or be false. Without a
  // stream, text() could allocate an unbounded decoded body before we inspect it.
 ...
 * offers neither is refused with challenge_unbounded_transport, regardless
 * of Content-Length.
 */
