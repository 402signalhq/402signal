...
execFileSync("npm", ["run", "build"], {
  cwd: resolve(repo, "integration/client-runtime"),
  stdio: "inherit",
});
...
for (const name of [
  ...
  await copy(`integration/client-runtime/dist/src/${name}.js`, `internal/${name}.js`);
await copy(
  "integration/client-runtime/owner-runtime/local-ledger.mjs",
  "internal/local-ledger.mjs",
);
await copy(
  "integration/client-runtime/solana-session-contracts/src/owner-session.mjs",
