...
export async function observeSolanaClose(rpc,plan,signature,voucher){
 try{
  ...
  // SEALED final distribution preserves the prior OPEN payout watermark. This
  // one-shot flow has no earlier distribution and independently checks every token leg.
