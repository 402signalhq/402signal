...
- Operational probe failures such as timeouts and upstream 5xx responses retain **HTTP 503**. Completed normal misses use **HTTP 200** with explicit unpaid billing; neither result invents a live URL.
