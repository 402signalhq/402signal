...
their original response, including a retained 503 response. Economic identities
remain permanent. See [private recovery](replay-recovery.md).
...
Buyer clients must retain their spend reservation until their own policy permits
release; a miss alone does not authorize another payment.
