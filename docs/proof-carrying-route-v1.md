...
`@402signal/route-guard@0.7.3` on the npm registry (provenance attested) and the [v0.7.3 release archive](https://github.com/402signalhq/402signal/releases/tag/route-guard-v0.7.3);
