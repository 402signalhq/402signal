...
Permanent task recipes: https://402signal.com/developers (each task has its own URL and `.md` equivalent). Reviewed package archives, checksums and scope: https://402signal.com/capabilities.json . This record separates publication from hosted enablement and dated qualification.
