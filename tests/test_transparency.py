...
class TransparencyPageTests(unittest.TestCase):
    ...
    def test_get_transparency_200_empty(self):
        ...
        self.assertIn("<title>Inspect decision checkpoints · 402Signal PQ Trust</title>", html)
    ...
    def test_homepage_omits_pq_card_without_confirmed(self):
        ...
        self.assertIn("A record you can check later.", html)
        self.assertIn("Keep the private request, receipt and reveal", html)
        self.assertIn('id="pq-log"', html)
        ...
        self.assertIn("A record you can check later.", static)
    ...
    def test_confirmed_homepage_exact_copy_and_evidence(self):
        ...
        self.assertIn("Evidence, oversight and long-term verification", html)
        self.assertNotIn("PQ-safe", html)
        self.assertIn("Evidence, oversight and long-term verification", html)
