...
class DeveloperRecipes(unittest.TestCase):
    ...
    def test_recovery_scopes_and_literal_commands_survive_markdown(self):
        ...
        self.assertIn('not a broken service', offer)
    ...
    def test_public_release_record_and_current_discovery(self):
        ...
        record = json.loads(text); self.assertEqual(len(record['packages']), 10)
    ...
    def test_copied_briefs_point_at_retrievable_recipes(self):
        ...
        for path in ('/developers/test-buyer', '/developers/check-offer', '/developers/hosted-session', '/developers/native-mpp', '/developers/sessions-and-invoices', '/developers/check-group-offer', '/developers/check-api-listing', '/developers/recover-routing-attempt', '/developers/evidence'):
