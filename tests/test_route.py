...
class PaywallTests(unittest.TestCase):
    ...
    def test_homepage(self):
        ...
        self.assertIn("$0.003 USDC when a supported offer qualifies under your rules", html)
        self.assertIn("Completed checks with no match are free", html)
        ...
        self.assertIn("Pre-spend checks for paid APIs", html)
        ...
        self.assertIn("Discover a capability", devs)
