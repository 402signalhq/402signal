 ...
 *
 * Matching package contents are on npm as @402signal/route-guard@0.7.7
...
const repoCapabilities = resolve(scriptDir, "../protocol/capabilities.json");
...
export function formatIdealTreeError({ nodeVersion, npmVersion, available = {} } = {}) {
  ...
  if (fallbacks.length) {
    return (
      ...
      "Digest verify already passed; the published 0.7.7 archive is intact. " +
